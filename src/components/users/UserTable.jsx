...
const UserTable = ({ users, onEdit, onDelete, onBlock, isMembersTable = false }) => {
    return (
            ...
            <table className="w-full text-sm text-left text-gray-500">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        {isMembersTable && <th scope="col" className="px-6 py-3">Active Plan</th>}
                    ...
                    {users.map(user => {
                        ...
                        return (
                            <tr key={user.id} className="bg-white border-b hover:bg-gray-50">
                                ...
                                {isMembersTable && (
                                    <td className="px-6 py-4">
                                        {activePlan ? activePlan.planName : 'N/A'}
                                    </td>
                                )}
