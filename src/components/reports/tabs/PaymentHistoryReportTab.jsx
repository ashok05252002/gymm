...
import { getPaymentHistoryReport, getPlans } from '../../../data/mockData';

const PaymentHistoryReportTab = () => {
    ...
    const handleGenerateReport = (currentFilters) => {
        const data = getPaymentHistoryReport(currentFilters);
        setReportData(data);
    };
...
export default PaymentHistoryReportTab;
