...
import { getSessionAttendanceReport, getUsers } from '../../../data/mockData';

const SessionAttendanceReportTab = () => {
    ...
    const handleGenerateReport = (currentFilters) => {
        const data = getSessionAttendanceReport(currentFilters);
        setReportData(data);
    };
...
export default SessionAttendanceReportTab;
